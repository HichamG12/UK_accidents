...
The license for this dataset is the Open Government Licence used by all data on data.gov.uk [(read more)](https://www.nationalarchives.gov.uk/doc/open-government-licence/version/3/). 

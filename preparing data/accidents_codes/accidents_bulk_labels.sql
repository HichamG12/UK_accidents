...
SET accident_severity = acdnt.accident_severity,
    carriageway_hazards = acdnt.carriageway_hazards,
    weather_conditions = acdnt.weather_conditions,
    urban_or_rural_area = acdnt.urban_or_rural_area,
    trunk_road_flag = acdnt.trunk_road_flag,
    special_conditions_at_site = acdnt.special_conditions_at_site,
    second_road_number = acdnt.second_road_number,
    second_road_class = acdnt.second_road_class,
    road_type = acdnt.road_type,
    road_surface_conditions = acdnt.road_surface_conditions,
    police_force = acdnt.police_force,
    pedestrian_crossing_human_control = acdnt.pedestrian_crossing_human_control,
    light_conditions = acdnt.light_conditions,
    pedestrian_crossing_physical_facilities = acdnt.pedestrian_crossing_physical_facilities,
    junction_detail = acdnt.junction_detail,
    junction_control = acdnt.junction_control,
    first_road_number = acdnt.first_road_number,
    first_road_class = acdnt.first_road_class,
    did_police_officer_attend_scene_of_accident = acdnt.did_police_officer_attend_scene_of_accident,
    day_of_week = acdnt.day_of_week
FROM
    ( SELECT (CASE
             ...
             (CASE
              ...
              END) day_of_week,
             (CASE
                  WHEN did_police_officer_attend_scene_of_accident = 1 THEN 'Yes'
                  ...
                  ELSE NULL
              END) did_police_officer_attend_scene_of_accident,
             (CASE
                  WHEN first_road_class = 1 THEN 'Motorway'
                  ...
                  ELSE NULL
              END) first_road_class,
             (CASE
                  WHEN first_road_number = 0 THEN 'Road class is C or Unclassified'
                  ELSE first_road_number
              END) first_road_number,
             (CASE
                  WHEN junction_control = 0 THEN 'Not at junction or within 20 metres'
                  ...
                  ELSE NULL
              END) junction_control,
             (CASE
                  WHEN junction_detail = 0  THEN 'Not at junction or within 20 metres'
              ...
              END) junction_detail,
             (CASE
                  WHEN pedestrian_crossing_physical_facilities = 0 THEN 'No physical crossing facilities within 50 metres'
                  WHEN pedestrian_crossing_physical_facilities = 1 THEN 'Zebra'
                  ...
                  ELSE NULL
              END) pedestrian_crossing_physical_facilities,
             (CASE
                  ...
                  ELSE NULL
              END) light_conditions,
             (CASE
                  WHEN pedestrian_crossing_human_control = 0 THEN 'None within 50 metres'
                  ...
                  ELSE NULL
              END) pedestrian_crossing_human_control,
             (CASE
             ...
             (CASE
              ...
              END) road_type,
             (CASE
                  WHEN second_road_class = 0 THEN 'Not at junction or within 20 metres'
                  ...
                  ELSE NULL
              END) second_road_class,
             (CASE
                  WHEN second_road_number = -1 THEN 'Unknown'
                  WHEN second_road_number =  0  THEN 'Road class is C or Unclassified'
              END) second_road_number,
             (CASE
                  WHEN special_conditions_at_site = 0 THEN 'None'
                  ...
                  ELSE NULL
              END) special_conditions_at_site,
             (CASE
                  WHEN trunk_road_flag = 1 THEN 'Trunk (Roads managed by Highways England)'

...
SET age_band_of_casualty = CASE WHEN age_band_of_casualty = 1  THEN '0 - 5'
...
UPDATE uk_accidents.dbo.casualties
SET bus_or_coach_passenger = CASE WHEN bus_or_coach_passenger = 0 THEN 'Not a bus or coach passenger'
...
UPDATE uk_accidents.dbo.casualties
SET car_passenger =  CASE WHEN car_passenger = 0 THEN 'Not car passenger'
...
UPDATE uk_accidents.dbo.casualties
SET casualty_class = CASE WHEN casualty_class = 1 THEN 'Driver or rider'
...
UPDATE uk_accidents.dbo.casualties
SET casualty_home_area_type = CASE WHEN casualty_home_area_type = 1 THEN 'Urban area'
...
UPDATE uk_accidents.dbo.casualties
SET casualty_imd_decile = CASE WHEN casualty_imd_decile = 1  THEN 'Most deprived 10%'
...
UPDATE uk_accidents.dbo.casualties
SET casualty_severity = CASE WHEN casualty_severity = 1 THEN 'Fatal'
...
UPDATE uk_accidents.dbo.casualties
SET casualty_type = CASE WHEN casualty_type = 0    THEN 'Pedestrian'
...
UPDATE uk_accidents.dbo.casualties
SET pedestrian_location = CASE WHEN pedestrian_location = 0  THEN 'Not a Pedestrian'
...
UPDATE uk_accidents.dbo.casualties
SET pedestrian_movement = CASE WHEN pedestrian_movement = 0 THEN 'Not a Pedestrian'
...
UPDATE uk_accidents.dbo.casualties
SET pedestrian_road_maintenance_worker = CASE WHEN pedestrian_road_maintenance_worker = 0 THEN 'No / Not applicable'
...
UPDATE uk_accidents.dbo.casualties
SET sex_of_casualty = CASE WHEN sex_of_casualty = 1 THEN 'Male'

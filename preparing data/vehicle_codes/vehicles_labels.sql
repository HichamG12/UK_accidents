...
UPDATE UK_accidents.dbo.vehicles
SET vehicle_leaving_carriageway = CASE
                                      WHEN vehicle_leaving_carriageway = 0 THEN 'Did not leave carriageway'
...
UPDATE UK_accidents.dbo.vehicles
SET hit_object_off_carriageway = CASE
                                     WHEN hit_object_off_carriageway = 0 THEN 'None'
...
UPDATE UK_accidents.dbo.vehicles
SET first_point_of_impact = CASE
                                WHEN first_point_of_impact = 0 THEN 'Did not impact'
...
--vehicle left hand drive
 ...
 UPDATE UK_accidents.dbo.vehicles
 SET vehicle_left_hand_drive = CASE
...
UPDATE UK_accidents.dbo.vehicles
SET journey_purpose_of_driver = CASE
                                    WHEN journey_purpose_of_driver = 1 THEN 'Journey as part of work'
...
UPDATE UK_accidents.dbo.vehicles
SET propulsion_code = CASE
                          WHEN propulsion_code = 1 THEN 'Petrol'
...
UPDATE UK_accidents.dbo.vehicles
SET driver_imd_decile = CASE
                            WHEN driver_imd_decile = 1 THEN 'Most deprived 10%'
...
UPDATE UK_accidents.dbo.vehicles
SET driver_home_area_type = CASE
                                WHEN driver_home_area_type = 1 THEN 'Urban area'
...
UPDATE UK_accidents.dbo.vehicles
SET hit_object_in_carriageway = CASE
                                    WHEN hit_object_in_carriageway = 0 THEN 'None'
...
SET vehicle_type = CASE
                       WHEN vehicle_type = 1 THEN 'Pedal cycle'
...
UPDATE UK_accidents.dbo.vehicles
SET towing_and_articulation = CASE
                                  WHEN towing_and_articulation = 0 THEN 'No tow/articulation'
...
UPDATE UK_accidents.dbo.vehicles
SET vehicle_manoeuvre = CASE
                            WHEN vehicle_manoeuvre = 1 THEN 'Reversing'
...
UPDATE UK_accidents.dbo.vehicles
SET vehicle_direction_from = CASE
                                 WHEN vehicle_direction_from = 0 THEN 'Parked'
...
UPDATE UK_accidents.dbo.vehicles
SET vehicle_direction_to = CASE
                               WHEN vehicle_direction_to = 0 THEN 'Parked'
...
UPDATE UK_accidents.dbo.vehicles
SET vehicle_location_restricted_lane = CASE
                                           WHEN vehicle_location_restricted_lane = 0 THEN 'On main carriageway - not in restricted lane'
...
UPDATE UK_accidents.dbo.vehicles
SET junction_location = CASE
                            WHEN junction_location = 0 THEN 'junction_location'
...
UPDATE UK_accidents.dbo.vehicles
SET skidding_and_overturning = CASE
                                   WHEN skidding_and_overturning = 0 THEN 'None'
